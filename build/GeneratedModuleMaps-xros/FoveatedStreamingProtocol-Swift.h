...
// Generated by Apple Swift version 6.4 (swiftlang-6.4.0.30.4 clang-2100.3.30.1)
#ifndef FOVEATEDSTREAMINGPROTOCOL_SWIFT_H
#define FOVEATEDSTREAMINGPROTOCOL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FoveatedStreamingProtocol",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
